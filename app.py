...
def init_session():
    ...
    st.session_state.setdefault("show_splash", True)
...
# ====== Entrada ======
def init_app():
    # --- PANTALLA DE BIENVENIDA (funcionalidad transitoria) ---
    st.session_state.setdefault("show_splash", True)
    if st.session_state.show_splash:
        ...
        <div class="splash-screen">
            <div class="title-blue">iAPPS</div>
            <div class="title-blue">TOURNAMENT</div>
            <div class="title-green">PÁDEL</div>
            {inject_global_layout("")}
            <div style="margin-top: 40px;">
                <p>Presionar para continuar</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
        if st.button("Presionar para continuar"):
